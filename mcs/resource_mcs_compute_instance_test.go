		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// 	"mcs_compute_instance.instance_1", "all_metadata.foo", "bar"),
					// resource.TestCheckResourceAttr(
					// 	"mcs_compute_instance.instance_1", "availability_zone", "nova"),
				),
			},
		},
	})
...
// 					testAccCheckComputeInstanceExists("mcs_compute_instance.instance_1", &instance),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "power_state", "active"),
...
// 					testAccCheckComputeInstanceExists("mcs_compute_instance.instance_1", &instance),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "power_state", "shutoff"),
...
// 					testAccCheckComputeInstanceExists("mcs_compute_instance.instance_1", &instance),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "power_state", "shelved_offloaded"),
...
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckComputeInstanceExists(
// 						"mcs_compute_instance.instance_1", &instance),
// 				),
// 			},
// 		},
// 	})
...
// 					testAccCheckComputeInstanceExists("mcs_compute_instance.instance_1", &instance),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "access_ip_v4", "192.168.1.100"),
// 				),
// 			},
// 		},
// 	})
...
// 						"mcs_compute_instance.instance_1", "all_metadata.foo", "bar"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "all_metadata.abc", "def"),
// 				),
// 			},
// 			{
...
// 						"mcs_compute_instance.instance_1", "all_metadata.foo", "bar"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "all_metadata.ghi", "jkl"),
// 				),
// 			},
// 		},
// 	})
...
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckComputeInstanceExists("mcs_compute_instance.instance_1", &instance),
// 					testAccCheckComputeInstanceNetworkExists("mcs_compute_instance.instance_1", &instance),
// 				),
// 			},
// 		},
// 	})
...
// 						"mcs_compute_instance.instance_1", "network.1.uuid", &network.ID),
// 				),
// 			},
// 		},
// 	})
...
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.1.uuid", &network1.ID),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.2.uuid", &network2.ID),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.3.uuid", &network1.ID),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.4.uuid", &network2.ID),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.5.uuid", &network1.ID),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.6.uuid", &network2.ID),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.1.name", "network_1"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.2.name", "network_2"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.3.name", "network_1"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.4.name", "network_2"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.5.name", "network_1"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.6.name", "network_2"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.7.name", "network_1"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.8.name", "network_2"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.1.fixed_ip_v4", "192.168.1.100"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.2.fixed_ip_v4", "192.168.2.100"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.3.fixed_ip_v4", "192.168.1.101"),
// 					resource.TestCheckResourceAttr(
// 						"mcs_compute_instance.instance_1", "network.4.fixed_ip_v4", "192.168.2.101"),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.5.port", &port1.ID),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.6.port", &port2.ID),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.7.port", &port3.ID),
// 					resource.TestCheckResourceAttrPtr(
// 						"mcs_compute_instance.instance_1", "network.8.port", &port4.ID),
// 				),
// 			},
// 		},
// 	})
...
// 	resourceName := "mcs_compute_instance.instance_1"
...
func testAccCheckComputeInstanceDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "mcs_compute_instance" {
			continue
		}
